...
public class Puzzle {
    ...
    //añade un método estático getTotalPuzzlesCreados() 
    // que devuelva el valor actual de contadorId (el mismo atributo static que ya usa el constructor). 
    // Sirve para practicar que un miembro static se puede consultar sin necesidad de tener un objeto Puzzle concreto.
